...
import { Paddles } from "./objects/paddle.tsx";
...
export default function CustomSpectate() {
    const location = useLocation();
    const queryParams = new URLSearchParams(location.search);
    const room : string = "customroom-" + queryParams.get('room');
